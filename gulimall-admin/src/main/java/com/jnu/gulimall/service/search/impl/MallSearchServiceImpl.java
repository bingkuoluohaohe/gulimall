...
import com.jnu.common.constant.EsConstant;
import com.jnu.common.to.es.SkuEsModel;
import com.jnu.common.utils.R;
import com.jnu.gulimall.config.GulimallElasticSearchConfig;
...
import com.jnu.gulimall.vo.AttrResponseVo;
import com.jnu.gulimall.vo.BrandVo;
    ...
    private SearchResult buildSearchResponse(SearchParam param, SearchResponse searchResponse) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                R r = attrService.attrInfo(Long.parseLong(s[0]));
                ...
                navVo.setLink("http://codekenan.icu/search/list.html?" + replace);
        ...
        if (param.getBrandId() != null && param.getBrandId().size() > 0) {
            ...
            navVo.setNavName("品牌");
            // TODO 远程查询所有品牌
            R r = brandService.brandsInfo(param.getBrandId());
            if (r.getCode() == 0) {
                ...
                navVo.setLink("http://codekenan.icu:12000/list.html?" + replace);
            }
            navs.add(navVo);
        }
